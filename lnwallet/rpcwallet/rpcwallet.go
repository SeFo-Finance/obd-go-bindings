...
import (
	...
	"github.com/SeFo-Finance/obd-go-bindings/lnwallet/btcwallet"
...
func (r *RPCKeyRing) NewAddress(addrType lnwallet.AddressType, change bool,
	...
	return r.WalletController.OB_NewAddress(addrType, change, account)
}
...
func (r *RPCKeyRing) SignTransaction(tx *wire.MsgTx,
) error {
	/*
		obd update wxf
		todo add code
...
func (r *RPCKeyRing) ComputePkhInputScript(tx *wire.MsgTx,
