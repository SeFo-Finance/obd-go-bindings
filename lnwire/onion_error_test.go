...
var onionFailures = []FailureMessage{
	...
	NewAmountBelowMinimum(UnitPrec11(testAmount), testChannelUpdate),
	NewFeeInsufficient(UnitPrec11(testAmount), testChannelUpdate),
	...
	NewFinalIncorrectHtlcAmount(UnitPrec11(testAmount)),
