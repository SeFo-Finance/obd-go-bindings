...
func TestGraphCacheAddNode(t *testing.T) {
	...
	runTest := func(nodeA, nodeB route.Vertex) {
		...
		//TODO: AssetId
		_ = cache.ForEachChannel(1, nodeA, func(c *DirectedChannel) error {
			fromChannels = append(fromChannels, c)
			return nil
		})
		//TODO: AssetId
		_ = cache.ForEachChannel(1, nodeB, func(c *DirectedChannel) error {
		...
		//TODO: AssetId
		_ = cache.ForEachNode(1, func(node route.Vertex,
