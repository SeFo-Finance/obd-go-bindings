...
import (
	...
	"github.com/SeFo-Finance/obd-go-bindings/routing/shards"
...
func (r *ChannelRouter) processUpdate(msg interface{},
	...
	case *channeldb.ChannelEdgeInfo:
		...
		fundingPkScript, err := input.GenerateP2SH(witnessScript)
		if err != nil {
			return err
		}
		...
		/*obd update wxf*/
		//todo asset'Capacity may err, asset'Capacity should not load from chanUtxo
