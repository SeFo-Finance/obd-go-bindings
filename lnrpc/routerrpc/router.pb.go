...
type SendPaymentRequest struct {
	...
	// obd update update wxf
	// Number of omniAmount to send. this field is only for asset transfer,
	// amt_msat only used for btc
	AssetAmt int64 `protobuf:"varint,2,opt,name=asset_amt,json=assetAmt,proto3" json:"asset_amt,omitempty"`
	...
	RouteHints []*obrpc.RouteHint `protobuf:"bytes,10,rep,name=route_hints,json=routeHints,proto3" json:"route_hints,omitempty"`
	//
	...
	//fallback.
	DestFeatures []obrpc.FeatureBit `protobuf:"varint,16,rep,packed,name=dest_features,json=destFeatures,proto3,enum=obrpc.FeatureBit" json:"dest_features,omitempty"`
	//
...
func (x *SendPaymentRequest) GetAssetAmt() int64 {
	if x != nil {
		return x.AssetAmt
	}
	return 0
...
func (x *SendPaymentRequest) GetRouteHints() []*obrpc.RouteHint {
	if x != nil {
		return x.RouteHints
	}
	return nil
...
func (x *SendPaymentRequest) GetDestFeatures() []obrpc.FeatureBit {
	if x != nil {
...
type SendToRouteRequest struct {
	...
	Route *obrpc.Route `protobuf:"bytes,2,opt,name=route,proto3" json:"route,omitempty"`
}
...
func (x *SendToRouteRequest) GetRoute() *obrpc.Route {
	if x != nil {
		return x.Route
	}
	return nil
...
type SendToRouteResponse struct {
	...
	Failure *obrpc.Failure `protobuf:"bytes,2,opt,name=failure,proto3" json:"failure,omitempty"`
}
...
func (x *SendToRouteResponse) GetFailure() *obrpc.Failure {
	if x != nil {
		return x.Failure
	}
	return nil
...
type BuildRouteResponse struct {
	...
	Route *obrpc.Route `protobuf:"bytes,1,opt,name=route,proto3" json:"route,omitempty"`
}
...
func (x *BuildRouteResponse) GetRoute() *obrpc.Route {
	if x != nil {
		return x.Route
	}
	return nil
...
type LinkFailEvent struct {
	...
	WireFailure obrpc.Failure_FailureCode `protobuf:"varint,2,opt,name=wire_failure,json=wireFailure,proto3,enum=obrpc.Failure_FailureCode" json:"wire_failure,omitempty"`
	//
...
func (x *LinkFailEvent) GetWireFailure() obrpc.Failure_FailureCode {
	if x != nil {
		return x.WireFailure
	}
	return obrpc.Failure_FailureCode(0)
}
...
type PaymentStatus struct {
	...
	Htlcs []*obrpc.HTLCAttempt `protobuf:"bytes,4,rep,name=htlcs,proto3" json:"htlcs,omitempty"`
}
...
func (x *PaymentStatus) GetHtlcs() []*obrpc.HTLCAttempt {
	if x != nil {
		return x.Htlcs
	}
	return nil
...
type UpdateChanStatusRequest struct {
	...
	ChanPoint *obrpc.ChannelPoint `protobuf:"bytes,1,opt,name=chan_point,json=chanPoint,proto3" json:"chan_point,omitempty"`
...
func (x *UpdateChanStatusRequest) GetChanPoint() *obrpc.ChannelPoint {
	if x != nil {
		return x.ChanPoint
	}
	return nil
...
var file_routerrpc_router_proto_rawDesc = []byte{
	...
	0x72, 0x70, 0x63, 0x1a, 0x12, 0x6f, 0x62, 0x5f, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x6e, 0x69, 0x6e,
	0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd9, 0x07, 0x0a, 0x12, 0x53, 0x65, 0x6e, 0x64,
	...
	0x73, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x61, 0x6d, 0x74, 0x5f, 0x6d, 0x73, 0x61, 0x74, 0x18, 0x0c,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x61, 0x6d, 0x74, 0x4d, 0x73, 0x61, 0x74, 0x12, 0x19, 0x0a,
	0x08, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x17, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x07, 0x61, 0x73, 0x73, 0x65, 0x74, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x61, 0x73, 0x73, 0x65,
	0x74, 0x5f, 0x61, 0x6d, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x61, 0x73, 0x73,
	0x65, 0x74, 0x41, 0x6d, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6f, 0x62, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x6f,
	...
	0x2e, 0x6f, 0x62, 0x72, 0x70, 0x63, 0x2e, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x42, 0x69,
	...
	0x32, 0x0c, 0x2e, 0x6f, 0x62, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x52, 0x05,
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x6f, 0x62, 0x72, 0x70, 0x63, 0x2e, 0x46, 0x61, 0x69,
	...
	0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6f, 0x62, 0x72, 0x70, 0x63, 0x2e,
	...
	0x10, 0x02, 0x32, 0xf7, 0x0b, 0x0a, 0x06, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x12, 0x43, 0x0a,
	0x10, 0x4f, 0x42, 0x5f, 0x53, 0x65, 0x6e, 0x64, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x56,
	...
	0x1a, 0x0e, 0x2e, 0x6f, 0x62, 0x72, 0x70, 0x63, 0x2e, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74,
	0x30, 0x01, 0x12, 0x45, 0x0a, 0x11, 0x4f, 0x42, 0x5f, 0x54, 0x72, 0x61, 0x63, 0x6b, 0x50, 0x61,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0e, 0x2e, 0x6f, 0x62, 0x72, 0x70, 0x63, 0x2e,
	...
	0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x6f, 0x62, 0x72, 0x70,
	...
	0x69, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x73, 0x2f, 0x6f, 0x62, 0x72, 0x70, 0x63, 0x2f, 0x72, 0x6f,
...
var file_routerrpc_router_proto_goTypes = []interface{}{
	...
	(*obrpc.RouteHint)(nil),                 // 43: obrpc.RouteHint
	(obrpc.FeatureBit)(0),                   // 44: obrpc.FeatureBit
	(*obrpc.Route)(nil),                     // 45: obrpc.Route
	(*obrpc.Failure)(nil),                   // 46: obrpc.Failure
	(obrpc.Failure_FailureCode)(0),          // 47: obrpc.Failure.FailureCode
	(*obrpc.HTLCAttempt)(nil),               // 48: obrpc.HTLCAttempt
	(*obrpc.ChannelPoint)(nil),              // 49: obrpc.ChannelPoint
	(*obrpc.Payment)(nil),                   // 50: obrpc.Payment
}
var file_routerrpc_router_proto_depIdxs = []int32{
	43, // 0: routerrpc.SendPaymentRequest.route_hints:type_name -> obrpc.RouteHint
	41, // 1: routerrpc.SendPaymentRequest.dest_custom_records:type_name -> routerrpc.SendPaymentRequest.DestCustomRecordsEntry
	44, // 2: routerrpc.SendPaymentRequest.dest_features:type_name -> obrpc.FeatureBit
	45, // 3: routerrpc.SendToRouteRequest.route:type_name -> obrpc.Route
	46, // 4: routerrpc.SendToRouteResponse.failure:type_name -> obrpc.Failure
	...
	45, // 11: routerrpc.BuildRouteResponse.route:type_name -> obrpc.Route
	...
	47, // 19: routerrpc.LinkFailEvent.wire_failure:type_name -> obrpc.Failure.FailureCode
	...
	48, // 22: routerrpc.PaymentStatus.htlcs:type_name -> obrpc.HTLCAttempt
	...
	49, // 27: routerrpc.UpdateChanStatusRequest.chan_point:type_name -> obrpc.ChannelPoint
	3,  // 28: routerrpc.UpdateChanStatusRequest.action:type_name -> routerrpc.ChanStatusAction
	5,  // 29: routerrpc.Router.OB_SendPaymentV2:input_type -> routerrpc.SendPaymentRequest
	6,  // 30: routerrpc.Router.OB_TrackPaymentV2:input_type -> routerrpc.TrackPaymentRequest
	...
	50, // 46: routerrpc.Router.OB_SendPaymentV2:output_type -> obrpc.Payment
	50, // 47: routerrpc.Router.OB_TrackPaymentV2:output_type -> obrpc.Payment
	...
	48, // 50: routerrpc.Router.SendToRouteV2:output_type -> obrpc.HTLCAttempt
