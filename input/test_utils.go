...
func (m *MockSigner) ComputePkhInputScript(tx *wire.MsgTx, signDesc *SignDescriptor) (*Script,
	error) {
	/*
		todo add test code for mock*/
	return nil, nil
}
func (m *MockSigner) SignTransaction(tx *wire.MsgTx) error {
	/*
		todo add test code for mock*/
	return nil
}
...
func (m *MockSigner) SignOutputRaw(tx *wire.MsgTx,
	...
	sig, err := txscript.RawTxInSignature(tx, signDesc.InputIndex, signDesc.WitnessScript, signDesc.HashType, privKey)
	if err != nil {
		return nil, err
	}
...
func (m *MockSigner) ComputeInputScript(tx *wire.MsgTx, signDesc *SignDescriptor) (*Script, error) {
	...
	case txscript.PubKeyHashTy:
		...
		/*
			obd update wxf
			omni not support WitnessV0PubKeyHashTy
		*/
